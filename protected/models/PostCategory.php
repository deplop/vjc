 ...
 *
 * The followings are the available columns in table 'tbl_post_category':
 * @property integer $id
...
class PostCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('post_id, category_id, created_time, updated_time', 'required'),
			array('post_id, category_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, post_id, category_id, created_time, updated_time', 'safe', 'on'=>'search'),
		);
	}
