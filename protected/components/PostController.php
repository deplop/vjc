	...
	public function actionUpdateClassify(){
		...
		if(isset($_POST["ClassifyForm"])){
			...
			if($formModel->validate()){
				...
				$edit = Post::model()->find("id=:id",array(":id"=>$formModel->id));
				...
				if(!$edit->save()){
					...
					foreach ($tags as $tag_name){
						...
						if(!isset($tag)){
							$tag = new Tag;
							$tag->tag = $tag_name;
							$tag->created_time = date("Y-m-d H:m:s");
						...
						$post_tag->created_time = date("Y-m-d H:m:s");
						$post_tag->updated_time = $post_tag->created_time;
					...
					//save categories
					foreach ($formModel->caegories as $category_id){
						$post_category = new PostCategory;
						$post_category->post_id = $edit->id;
							
						$post_category->category_id = $category_id;
						$post_category->created_time = date("Y-m-d H:m:s");
